...
export const metadata: Metadata = { title: "مدیریت خدمات", robots: { index: false } };
    ...
    <div className="mx-auto max-w-6xl px-5 pt-32 pb-24 sm:px-8 sm:pt-36">
      ...
      <div className="mb-10 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black sm:text-3xl">مدیریت خدمات</h1>
            <p className="mt-1 text-sm text-muted">
              خدماتی که در صفحه‌ی اصلی سایت نمایش داده می‌شوند.
            </p>
          </div>
        </div>
        <Link
            ...
            >
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="tabular-fa rounded-full bg-ring px-2.5 py-0.5 text-[11px] font-bold text-muted">
                    ترتیب: {toFa(item.order)}
                  </span>
                </div>
              ...
              <div className="flex shrink-0 gap-2">
                ...
                <DeleteButton action={deleteServiceAction.bind(null, item.id)} />
              </div>
            </article>
          ))}
        </div>
