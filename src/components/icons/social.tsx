...
export function SocialIcon({
  platform,
  ...props
}: { platform: string } & SVGProps<SVGSVGElement>) {
  const Icon = MAP[platform] ?? MailIcon;
  return <Icon {...props} />;
}
